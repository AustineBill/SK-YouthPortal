...
const ScheduleDetails = () => {
  ...
  const handleNext = () => {
    ...
    console.log('Saving to sessionStorage:', { reservationType, participants, sharedDetails });
    sessionStorage.setItem('scheduleDetails', JSON.stringify({ reservationType, participants, sharedDetails }));
