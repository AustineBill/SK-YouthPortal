  ...
  return (
    <div className="container-fluid">
      ...
      <Container>
        ...
        <div
          className="terms-and-conditions overflow-auto"
        ...
        >
          ...
          <p>
            ...
            affirm that all items are correct and in good condition at the time
            of receipt. I understand and agree to the following terms:
          </p>
          ...
          <h6>
            2. In the event that any item is damaged, I acknowledge that I will
            be held liable for the actual repair or replacement of the damaged
            item. The corresponding value will be determined based on the
            current market value or the purchase price of the item, whichever is
            higher.
          </h6>
          <h6>
          ...
          <h6>
            ...
            agreed-upon purpose and that I will not be allowed to borrow any
            items in the future if any of the terms and conditions are violated.
          </h6>
          <h6>
