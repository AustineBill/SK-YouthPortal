        ...
        <div className="admin-dashboard-container">
            ...
            <div className="year-dropdown-container d-flex align-items-center">
                <div className='year-selection-container d-flex align-items-center'>
                    <label className='year-selection-label m-0' htmlFor="year-select">Select Year:</label>
                    <select
                        id="year-select"
                        value={selectedYear}
                        onChange={handleYearChange}
            ...
            <section className="admin-dashboard-charts-section">
                <div className='admin-dashboard-charts-container d-flex align-items-center text-center'>
                    ...
                    <div className="admin-chart-container">
                        ...
                        <Bar data={ratingsChartData} options={{ indexAxis: 'y' }} className="chart" />
                    </div>
                </div>
            </section>
          ...
          <Doughnut data={donutChartData} className="chart" />
        </div> */}

            {/* Reservation Graph */}
            {/* <div className="admin-chart-container">
          <h3>Reservation Graph</h3>
          <Bar data={reservationChartData} className="chart" />
        </div> */}

            {/* Equipment Reservation Graph */}
            {/* <div className="admin-chart-container">
          <h3>Equipment Reservation Graph</h3>
          <Bar data={equipmentChartData} className="chart" />
        </div> */}

            {/* Yearly Ratings Graph */}
            {/* <div className="admin-chart-container">
          <h3>Yearly Ratings Distribution</h3>
          <Bar data={ratingsChartData} options={{ indexAxis: 'y' }} className="chart" />
        </div>
      </section> */}
        </div>
