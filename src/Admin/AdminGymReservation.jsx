...
const AdminGymReservations = () => {
  const navigate = useNavigate();
  const [reservations, setReservations] = useState([]);
  const [selectedCategory, setSelectedCategory] = useState(
    sessionStorage.getItem('reservationCategory') || 'All' // Load from sessionStorage or default to 'All'
  );
    ...
    const fetchReservations = async () => {
      try {
        ...
        if (selectedCategory === 'All') {
          endpoint = 'http://localhost:5000/viewScheduleAndEquipment'; // Combined data from both tables
        } else if (selectedCategory === 'Facility') {
          endpoint = 'http://localhost:5000/reservations'; // All facility reservations
        } else if (selectedCategory === 'Equipment') {
          endpoint = 'http://localhost:5000/schedule/equipment'; // All equipment schedules
        }
          ...
          <Col className="d-flex justify-content-end">
            <Dropdown>
              ...
              <Dropdown.Menu>
                ...
                <Dropdown.Item onClick={() => setSelectedCategory('Facility')}>Facilities</Dropdown.Item>
                <Dropdown.Item onClick={() => setSelectedCategory('Equipment')}>Equipment Schedules</Dropdown.Item>
              </Dropdown.Menu>
            </Dropdown>
          </Col>
        </Row>
                ...
                <tr key={reservation.id || reservation.reservation_id}>
                  {selectedCategory === 'All' ? (
                    <>
                      ...
                      <td>{reservation.reserved_equipment || 'N/A'}</td>
...
export default AdminGymReservations;
